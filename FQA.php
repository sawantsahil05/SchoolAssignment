...
$QUERY="select * from faqq";
$result=mysqli_query($conn,$QUERY);
$faqq=mysqli_fetch_all($result,MYSQLI_ASSOC);
...
$QUERY="INSERT INTO faqq(Question,Answer) 
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form method="POST" action="FQA.php">
                                                     
                                                    <div class="form-group">
                                                        <label for="recipient-name" class="control-label">QUESTION:</label>
                                                        <input type="text" name="QUESTION" class="form-control" id="recipient-name1">
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="message-text" class="control-label">ANSWER:</label>
                                                        <input name="ANSWER" class="form-control" id="message-text1">
                                                    </div>
